...
import com.hackathon.coachmarks.R;
 ...
 *  2) The {@link CoachMarks#dismiss()} method is called
 *
 ...
 *
 */
public abstract class CoachMarks {
    ...
    protected CoachMarks(CoachMarkBuilder builder) {
    ...
    /**
     * Exposes the {@link PopupWindow#getContentView()} method of {@link CoachMarks#mPopup}
     */
    ...
    /**
     * Exposes the {@link PopupWindow#isShowing()} method of {@link CoachMarks#mPopup}
     */
     ...
     * existing listener with a call to {@link CoachMarks#dismiss()}
     *
     *
     *
     */
    ...
    public abstract static class CoachMarkBuilder {
        ...
        /**
         * Set an {@link CoachMarks.OnDismissListener} to be called when the
         * coach mark is dismissed
         *
         * @param listener
         */
        ...
        /**
         * Set an {@link CoachMarks.OnTimeoutListener} to be called when the
        ...
        /**
         * Set an {@link CoachMarks.OnShowListener} to be called when the
         * coach mark is shown
         *
         * @param listener
         */
        ...
        public abstract CoachMarks build();
    }
}